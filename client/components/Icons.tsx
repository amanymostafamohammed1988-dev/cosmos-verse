...
// Service Icons
export const CriminalLawIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
  ...
  >
    ...
    <desc>Shield with scales representing criminal defense and legal protection</desc>
...
export const BusinessLawIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
  ...
  >
    ...
    <desc>Building with briefcase representing corporate and business legal services</desc>
    <path d="M3 21h18"/>
...
export const FamilyLawIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const LitigationIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
  ...
  >
    ...
    <desc>Courthouse with gavel representing civil litigation and court proceedings</desc>
    <path d="M3 21h18"/>
...
// Values Icons
export const IntegrityIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const ExcellenceIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const DedicationIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
  ...
  >
    ...
    <desc>Target with arrow representing dedication and focused commitment</desc>
...
// Timeline Icons
export const MilestoneIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
// FAQ Category Icons
export const AllQuestionsIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const ExperienceIcon: React.FC<IconProps> = ({ className = "w-12 h-12" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const ResponsivenessIcon: React.FC<IconProps> = ({ className = "w-12 h-12" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const ConfidentialityIcon: React.FC<IconProps> = ({ className = "w-12 h-12" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const ResultsIcon: React.FC<IconProps> = ({ className = "w-12 h-12" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const PersonalizedIcon: React.FC<IconProps> = ({ className = "w-12 h-12" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const TransparentIcon: React.FC<IconProps> = ({ className = "w-12 h-12" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
// Accreditation Icons
export const BarAssociationIcon: React.FC<IconProps> = ({ className = "max-w-full max-h-full" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const ISOIcon: React.FC<IconProps> = ({ className = "max-w-full max-h-full" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const LegalExcellenceIcon: React.FC<IconProps> = ({ className = "max-w-full max-h-full" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
...
export const ChambersIcon: React.FC<IconProps> = ({ className = "max-w-full max-h-full" }) => (
  <svg 
    className={className}
    viewBox="0 0 24 24" 
    stroke="currentColor" 
