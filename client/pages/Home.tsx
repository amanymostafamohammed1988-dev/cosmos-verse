  ...
  const teamValues = [
    {
      ...
      title: "Integrity",
      description: "We maintain the highest ethical standards in all our legal practice and client relationships."
    },
    {
      icon: "/assets/icons/values/excellence.svg",
      title: "Excellence", 
      description: "Our commitment to legal excellence drives us to achieve the best possible outcomes for our clients."
    },
    {
      icon: "/assets/icons/values/dedication.svg",
      title: "Dedication",
      description: "We are dedicated to providing personalized attention and unwavering support to every client."
    }
  ];
  ...
  const legalInsights = [
    {
      ...
      title: "New Regulations in Corporate Compliance: What Your Business Needs to Know",
      excerpt: "Recent changes in corporate compliance regulations require immediate attention from business owners...",
    ...
    },
    {
      ...
      category: "Family Law",
      title: "Understanding Child Custody Laws: A Parent's Guide to Legal Rights",
      excerpt: "Navigating child custody can be complex. Learn about your rights and the legal process...",
    ...
    },
    {
      ...
      excerpt: "Understanding your constitutional rights during police interactions is crucial for every citizen...",
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-montserrat font-bold mb-6 leading-tight animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
              Your Legal Success
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-xs font-roboto uppercase tracking-wide">Scroll</span>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div 
              ...
              className={`order-2 lg:order-1 text-center transition-all duration-1000 ${
                isVisible['about-image'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
            >
          ...
          <div 
            ...
            className={`mt-20 transition-all duration-1000 delay-400 ${
              isVisible['values-section'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div 
            ...
            className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 transition-all duration-1000 delay-200 ${
              isVisible['services-grid'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
      ...
      <section className="bg-gradient-to-br from-lawfirm-medium-navy via-lawfirm-dark-blue to-lawfirm-medium-navy py-20 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div 
            ...
            data-animate
            className={`text-center mb-16 transition-all duration-1000 ${
              isVisible['insights-header'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
            <div className="mb-4">
              <span className="inline-block bg-gradient-to-r from-lawfirm-gold to-yellow-400 text-white px-6 py-3 rounded-full text-sm font-roboto font-medium uppercase tracking-wide shadow-lg">
          ...
          <div 
            ...
            className={`grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-1000 delay-200 ${
              isVisible['insights-grid'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
          ...
          >
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl font-montserrat font-bold text-white mb-6 leading-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-lawfirm-gold to-yellow-400"> Today</span>
              </h2>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-lawfirm-gold to-yellow-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    <img src="/assets/icons/contact/phone.svg" alt="Phone" className="w-6 h-6 filter brightness-0 invert" />
                  </div>
                  <div>
                    <div className="text-lawfirm-gold font-roboto font-medium">Phone</div>
                    <div className="text-white font-roboto text-lg">(555) 123-4567</div>
                  </div>
                </div>
                <div className="flex items-center space-x-4 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-lawfirm-gold to-yellow-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    <img src="/assets/icons/contact/email.svg" alt="Email" className="w-6 h-6 filter brightness-0 invert" />
                  </div>
                  <div>
                    <div className="text-lawfirm-gold font-roboto font-medium">Email</div>
                    <div className="text-white font-roboto text-lg">contact@lawfirm.com</div>
                  </div>
                </div>
                <div className="flex items-center space-x-4 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-lawfirm-gold to-yellow-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    <img src="/assets/icons/contact/location.svg" alt="Location" className="w-6 h-6 filter brightness-0 invert" />
                  </div>
                  <div>
                    <div className="text-lawfirm-gold font-roboto font-medium">Office</div>
                    <div className="text-white font-roboto text-lg">123 Legal Street<br />City, State 12345</div>
                  </div>
                </div>
                <div className="flex items-center space-x-4 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-lawfirm-gold to-yellow-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    <img src="/assets/icons/contact/clock.svg" alt="Hours" className="w-6 h-6 filter brightness-0 invert" />
                  </div>
                  <div>
                    <div className="text-lawfirm-gold font-roboto font-medium">Hours</div>
                    <div className="text-white font-roboto text-lg">Mon-Fri: 8:00 AM - 6:00 PM<br />Sat: 9:00 AM - 2:00 PM</div>
                  </div>
                </div>
              </div>
            </div>
