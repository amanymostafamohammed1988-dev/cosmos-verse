...
export function About() {
  ...
  const values = [
    {
      ...
      title: "Mission",
      description:
        "To provide exceptional legal representation with unwavering commitment to justice, integrity, and client success.",
      background: "bg-white",
    },
    {
      ...
      title: "Vision",
      description:
        "To be the most trusted and respected law firm, setting the standard for excellence in legal services and client care.",
    ...
    },
    {
      ...
      title: "Values",
      description:
        "Integrity, excellence, dedication, and client-focused service guide everything we do in pursuit of justice.",
      background: "bg-white",
    },
  ];
  ...
  const differentiators = [
    {
      ...
      description:
        "Over 25 years of successful legal practice across multiple jurisdictions.",
    },
    {
      icon: "/assets/icons/diff/responsiveness.svg",
      title: "24/7 Responsiveness",
      description:
        "Always available when you need us most, with rapid response times.",
    },
    {
      icon: "/assets/icons/diff/confidentiality.svg",
      title: "Complete Confidentiality",
      description:
        "Your privacy and sensitive information are our highest priority.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Tailored legal strategies designed specifically for your unique situation.",
    },
    {
  ...
  const timeline = [
    ...
    },
    {
      ...
      description:
        "Received State Bar Association's Excellence in Legal Services Award.",
    },
    {
      year: "2018",
      title: "Digital Innovation",
      description:
        "Launched innovative digital client portal and case management system.",
    },
    {
      year: "2023",
      title: "25th Anniversary",
      description:
        "Celebrating 25 years of legal excellence and client success.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "The team provided exceptional service and achieved results beyond our expectations. Their professionalism and expertise made all the difference.",
      name: "Jennifer Martinez",
      role: "Business Owner",
    },
    {
      quote:
        "Outstanding legal representation with personal attention. They guided us through every step of the complex litigation process.",
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-lawfirm-dark-navy mb-8 font-roboto leading-relaxed">
                For over 25 years, we have been dedicated to providing
                exceptional legal services with integrity, expertise, and
                unwavering commitment to our clients' success. Our experienced
                team stands ready to guide you through your legal challenges.
              </p>
              <Link
                to="/contact"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-lawfirm-dark-navy mb-6 font-roboto leading-relaxed">
                ...
                dedication, our firm has built a reputation as one of the
                region's most trusted legal practices. We combine traditional
                values with innovative approaches to deliver outstanding results
                for our clients.
              </p>
              <p className="text-lg text-lawfirm-dark-navy mb-6 font-roboto leading-relaxed">
                Our comprehensive legal services span multiple practice areas,
                ensuring that we can address all aspects of your legal needs
                under one roof. From complex corporate matters to personal legal
                challenges, we bring the same level of expertise and commitment
                to every case.
              </p>
              <p className="text-lg text-lawfirm-dark-navy font-roboto leading-relaxed">
                What sets us apart is our personalized approach to client
                service. We believe that every client deserves individual
                attention and customized legal strategies that align with their
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-lawfirm-dark-navy font-roboto max-w-3xl mx-auto">
              ...
              to excellence in legal services.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className={`${value.background} p-8 rounded-lg shadow-lg text-center`}
              >
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-lawfirm-dark-navy font-roboto max-w-3xl mx-auto">
              Meet the experienced professionals who lead our firm and guide our
      ...
      {/* Timeline */}
      <section
        className="bg-lawfirm-light-gray py-20"
        style={{
          backgroundImage: "url('/assets/images/timeline-bg.jpg')",
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-lawfirm-dark-navy font-roboto max-w-3xl mx-auto">
              Milestones that have shaped our firm's growth and commitment to
              excellence.
            </p>
          </div>
              ...
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute left-0 md:left-1/2 md:transform md:-translate-x-1/2 w-8 h-8 bg-lawfirm-gold rounded-full flex items-center justify-center">
                    <img
                      src="/assets/icons/timeline/milestone.svg"
                      alt="Milestone"
                      className="w-4 h-4"
                    />
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-lawfirm-dark-navy font-roboto">
              Recognized by leading legal organizations for our commitment to
              excellence.
            </p>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-lawfirm-dark-navy font-roboto max-w-3xl mx-auto">
              Real testimonials from clients who have experienced our dedication
              to excellence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-lawfirm-light-gray p-8 rounded-lg shadow-lg"
              >
                <div className="w-8 h-8 mb-4">
                  <img
                    src="/assets/icons/ui/quote.svg"
                    alt="Quote"
                    className="w-full h-full text-lawfirm-gold"
                  />
                </div>
      ...
      <section className="bg-lawfirm-dark-blue py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 font-roboto max-w-3xl mx-auto">
            ...
            their legal needs. Contact us today to discover how our experienced
